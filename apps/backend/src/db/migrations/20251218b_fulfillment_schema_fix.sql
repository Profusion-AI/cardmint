-- Fix fulfillment schema: subtotal_cents -> original/final_subtotal_cents
-- Safe to DROP since table has no data (verified 2025-12-17)
-- Required because webhook INSERT expects dual subtotal columns

DROP TABLE IF EXISTS fulfillment;

-- Recreate with correct dual-subtotal schema
